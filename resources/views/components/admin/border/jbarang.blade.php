...
<a href="#" class="m-2 p-2 flex items-center rounded-lg border shadow-md bg-gradient-to-b from-blue-400 to-sky-700">
    ...
    <div class="flex flex-col justify-between p-4 leading-normal">
        <h5 class="mb-2 text-2xl font-medium tracking-tight text-white dark:text-white">Jumlah barang</h5>
        <p class="mb-3 text-4xl text-center font-bold text-white dark:text-gray-400">12</p>
    </div>
</a>
