      ...
      <div class="modal-body relative p-4">
        ...
        <div class="flex justify-center w-full ">
          <div class="block p-4 rounded-lg shadow-lg bg-gradient-to-b from-gray-200 to-zinc-300">
              ...
              <input type="hidden" name="kode" value="{{Str::random(4);}}">
    
              <div class="form-group mb-6">
                <input name="nama_barang" type="text" class="form-control block
                  w-full
                  px-3
                  py-1.5
                  text-base
              ...
              <div class="form-group mb-6">
                <input name="stok" type="number" class="form-control block
                  w-full
                  px-3
                  py-1.5
                  text-base
              ...
              <div class="flex justify-center">
                <div class="mb-3 w-full">
                  <label for="formFile" class="form-label inline-block mb-2 text-gray-700">Masukan Gambar</label>
